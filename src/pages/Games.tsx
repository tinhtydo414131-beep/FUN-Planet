              ...
              {(() => {
                ...
                return (
                  <div className="relative max-w-6xl mx-auto">
                    ...
                    <div className="absolute -inset-4 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-[40px] opacity-20 blur-2xl animate-pulse"></div>
                    
                    {/* Main Card */}
                    <div className="relative bg-gradient-to-br from-white via-orange-50 to-yellow-50 rounded-[32px] border-4 border-orange-400 shadow-2xl overflow-hidden">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute -top-2 -right-2 z-10 animate-bounce">
                              <div className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 text-white px-5 py-2 rounded-full font-fredoka font-bold text-sm shadow-lg border-2 border-white flex items-center gap-2">
                                ✨ NEW ✨
                              </div>
                            </div>
                            
                            {/* Image Container */}
                            <div className="relative rounded-3xl overflow-hidden border-4 border-orange-300 shadow-xl group">
                              <img 
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full">
                                ...
                                <span className="font-fredoka font-bold text-white text-sm">SIÊU PHẨM</span>
                              </div>
                              
                              <h2 className="text-4xl sm:text-5xl font-fredoka font-bold bg-gradient-to-r from-orange-600 via-red-500 to-pink-500 bg-clip-text text-transparent leading-tight">
                                Thợ Đào Vàng
                              </h2>
                            ...
                            <div className="flex flex-wrap gap-3">
                              <div className="px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-yellow-100 border-2 border-orange-300">
                                <span className="font-fredoka font-bold text-orange-700 flex items-center gap-2">
                                  🎮 <span>{featuredGame.genre}</span>
                                </span>
                              </div>
                              <div className="px-4 py-2 rounded-full bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-300">
                                <span className="font-fredoka font-bold text-green-700 flex items-center gap-2">
                                  ⭐ <span>easy</span>
                                </span>
                              </div>
                            </div>
                            ...
                            {/* Stats */}
                            <div className="flex items-center gap-6 text-base font-comic text-gray-600">
                              <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full border-2 border-orange-200">
                                <span className="text-xl">🎯</span>
                                <span className="font-bold">{featuredGame.total_plays || 0}</span>
                                <span className="text-sm">plays</span>
                              </div>
                              <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full border-2 border-pink-200">
                                <span className="text-xl">❤️</span>
                                <span className="font-bold">{featuredGame.total_likes || 0}</span>
                            ...
                            <Button
                              ...
                              className="w-full sm:w-auto font-fredoka font-bold text-xl px-10 py-7 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 hover:from-orange-600 hover:via-red-600 hover:to-pink-600 text-white shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all rounded-2xl group relative overflow-hidden"
                            >
