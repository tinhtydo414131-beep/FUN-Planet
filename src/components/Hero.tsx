...
export const Hero = () => {
  ...
  return (
    <section className="relative pt-24 sm:pt-28 pb-12 sm:pb-16 px-4 overflow-hidden min-h-screen flex flex-col justify-center">
      {/* Background video */}
      <video
        autoPlay
        loop
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center space-y-6 sm:space-y-8">
          ...
          >
            ...
            >
              <Diamond className="w-10 h-10 sm:w-16 sm:h-16 md:w-24 md:h-24 text-cyan-400 drop-shadow-[0_0_30px_rgba(34,211,238,0.8)]" />
            </motion.div>
          ...
          >
            <div className="relative group">
              ...
              <Input
                ...
                className="pl-10 sm:pl-14 pr-24 sm:pr-32 py-5 sm:py-7 text-base sm:text-lg font-rajdhani font-medium bg-white/10 backdrop-blur-md border-2 border-primary/40 focus:border-cyan-400 rounded-2xl shadow-lg text-white placeholder:text-white/60 focus:ring-4 focus:ring-cyan-400/20"
              />
              <Button 
                type="submit"
                onMouseEnter={() => playPop()}
                onClick={() => playClick()}
                className="absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 font-space font-bold px-4 sm:px-8 py-4 sm:py-5 text-sm sm:text-base bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 shadow-lg"
              >
                Search 🚀
              </Button>
            </div>
