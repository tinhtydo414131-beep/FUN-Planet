...
import { Users, Gamepad2, Play, Upload, Gem, Crown, Heart, User, ChevronRight, RefreshCw, Medal } from "lucide-react";
...
const PodiumCard = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={`text-xs font-bold truncate max-w-[100px] text-center drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)] ${
      ...
      <div className="flex items-center gap-1 mt-0.5">
        ...
        <span className="text-xs font-extrabold text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]" style={{ textShadow: '0 0 10px rgba(255,255,255,0.8)' }}>
...
const floatingParticles = [
  ...
  { emoji: "⭐", delay: 0.3, x: "88%", y: "20%", duration: 5 },
  { emoji: "🌟", delay: 0.9, x: "12%", y: "65%", duration: 3.5 },
  { emoji: "🔥", delay: 1.5, x: "78%", y: "35%", duration: 5.5 },
];
    ...
    <>
      <div className="relative h-full flex flex-col">
        ...
        >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex-1 flex items-center justify-between min-w-0">
                      ...
                      <div className="flex items-center gap-1">
                        {isCamly && <Gem className="h-3 w-3 text-rose-400 drop-shadow-[0_0_6px_rgba(244,63,94,0.8)]" />}
                        <span className="relative z-20 text-base font-black text-white drop-shadow-[0_0_12px_rgba(255,255,255,0.9)]" style={{ textShadow: '0 0 8px #fff, 1px 1px 2px #000' }}>
                          {statsLoading ? (
                        ...
                        <span className="text-xs text-white font-medium drop-shadow-[0_0_4px_rgba(255,255,255,0.5)]">{item.suffix}</span>
                      </div>
                    </div>
                  </motion.div>
                );
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="flex gap-2 mb-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-1.5 px-3 rounded-xl font-semibold transition-all duration-300 ${
                    activeTab === "creators"
                      ? "bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg shadow-teal-500/50"
                      : "bg-white/10 !text-white hover:bg-white/20"
                  }`}
                >
                  <Gamepad2 className={`h-3.5 w-3.5 ${activeTab === "creators" ? "!text-white" : "!text-yellow-400"}`} />
                  <span className={`text-sm font-bold ${activeTab === "creators" ? "!text-white" : "!text-yellow-400"}`}>Top Creators</span>
                </button>
                <button
                ...
                >
                  <Gem className={`h-3.5 w-3.5 ${activeTab === "donors" ? "!text-white" : "!text-yellow-400"}`} />
                  <span className={`text-sm font-bold ${activeTab === "donors" ? "!text-white" : "!text-yellow-400"}`}>Top Donors</span>
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-1.5">
                <AnimatePresence mode="wait">
                  {legendsLoading ? (
                      ...
                      {creators.length === 0 ? (
                        ...
                        creators.map((creator, index) => {
                          ...
                          return (
                            ...
                            >
                              <span className="text-base w-6 text-center font-bold !text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
                                {getRankIcon(rank)}
                              </span>
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="font-semibold truncate text-sm !text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">{creator.username}</div>
                              ...
                              <div className="text-right">
                                ...
                                <div className="flex items-center gap-1 text-[10px] !text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
                    ...
                    >
                      {donors.length === 0 ? (
                        <div className="text-center py-4 text-sm" style={{ color: 'white' }}>
                        ...
                        donors.map((donor, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="font-semibold text-sm !text-white truncate drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">{donor.username}</div>
                                <div className={`text-[10px] ${badge.color}`}>{badge.label}</div>
                              </div>
                              <div className="text-right">
                                <div className="flex items-center gap-1 text-xs font-bold text-rose-300 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
              ...
              <div className="mt-2 pt-2">
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-semibold py-1.5 rounded-xl shadow-lg shadow-rose-500/30 transition-all hover:shadow-rose-500/50 text-sm"
                >
          ...
          <div className="md:hidden h-1 w-full relative z-10 my-2">
            <div 
              className="h-full w-full"
              style={{
                background: `linear-gradient(90deg, 
          ...
          <div className="flex-1 flex flex-col p-3 relative z-10 min-w-0">
            ...
            {rankingLoading ? (
              <div className="space-y-2 flex-1">
                {Array.from({ length: 5 }).map((_, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 rounded-xl border border-white/30 bg-white/10 p-2"
                  >
              ...
              <>
                ...
                {rankingError && (
                  <div className="text-center py-6">
                    ...
                    <p className="text-red-300 text-xs font-semibold mb-2">{rankingError}</p>
                    <button
                      onClick={() => fetchTopUsers(true)}
                      className="px-3 py-1.5 bg-yellow-500/20 hover:bg-yellow-500/30 border border-yellow-400/50 rounded-full text-yellow-300 text-xs font-medium transition-colors"
                    >
                      Thử lại
                    </button>
                  </div>
                ...
                {/* Empty State */}
                {!rankingError && topUsers.length === 0 && (
                  <div className="text-center py-6">
                    <motion.span
                    ...
                    <p className="text-white/80 text-sm font-semibold">Chưa có ai trong bảng xếp hạng</p>
                    <p className="text-yellow-300/70 text-xs mt-1">Hãy là người đầu tiên!</p>
                  </div>
                )}

                {/* Remaining Rankings */}
                {remainingUsers.length > 0 && (
                  <ScrollArea className="h-[280px] pr-2 ranking-scrollbar flex-1">
                          ...
                          <HoverCard key={rankedUser.id} openDelay={200}>
                            <HoverCardTrigger asChild>
                              <motion.div
                                ...
                                className={`flex items-center gap-2 rounded-xl border p-2 backdrop-blur-sm cursor-pointer transition-all border-white/35 bg-gradient-to-r from-white/15 to-white/10 ${
                              ...
                              >
                                ...
                                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-yellow-500/30 to-amber-500/20">
                                  <span className="text-xs font-bold bg-gradient-to-r from-yellow-300 to-amber-400 bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(255,215,0,0.9)]">
                                    #{rank}
                                  </span>
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                  <p
                                    className={`truncate max-w-[100px] text-sm font-bold drop-shadow-[0_1px_2px_rgba(0,0,0,0.7)] ${
                                      isCurrentUser ? "text-yellow-300" : "text-white"
                                    }`}
                                  >
                                    {rankedUser.username}
                                ...
                                {/* Balance */}
                                <div className="flex items-center gap-1 rounded-full bg-gradient-to-r from-yellow-500/50 to-amber-500/40 px-2 py-1 border-2 border-yellow-400/70 shadow-[0_0_15px_rgba(255,215,0,0.6)]">
                                  <Gem className="h-3 w-3 text-white drop-shadow-[0_0_6px_rgba(255,255,255,0.8)]" />
                                  <span className="text-xs font-extrabold text-white drop-shadow-[0_0_6px_rgba(255,255,255,0.8)]" style={{ textShadow: '0 0 8px rgba(255,255,255,0.7)' }}>
                            ...
                            <HoverCardContent
                              className="w-56 bg-gradient-to-br from-purple-500/95 via-pink-500/90 to-yellow-400/95 border-pink-400/50 backdrop-blur-xl"
                              side="top"
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-1 mt-1">
                                    <Gem className="h-3 w-3 text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.7)]" />
                                    <span className="text-xs font-bold text-white" style={{ textShadow: '0 0 6px rgba(255,255,255,0.7)' }}>
            ...
            >
              <Button
                ...
                variant="outline"
                className="w-full rounded-xl border-2 border-yellow-400/60 bg-gradient-to-r from-yellow-500/30 to-amber-500/30 font-bold text-yellow-100 hover:border-yellow-300 hover:from-yellow-500/40 hover:to-amber-500/40 hover:text-white transition-all shadow-[0_0_15px_rgba(255,215,0,0.3)] text-sm py-1.5"
              >
                Xem Tất Cả
