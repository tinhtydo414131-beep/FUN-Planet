...
const floatingParticles = [
  { emoji: "👤", delay: 0, x: "4%", y: "10%", duration: 4 },
  { emoji: "🎮", delay: 0.5, x: "46%", y: "5%", duration: 5 },
  { emoji: "💎", delay: 1, x: "6%", y: "50%", duration: 4.5 },
  { emoji: "👑", delay: 1.5, x: "45%", y: "55%", duration: 3.5 },
  { emoji: "✨", delay: 0, x: "54%", y: "15%", duration: 4, size: "text-xl" },
  { emoji: "⭐", delay: 0.3, x: "96%", y: "20%", duration: 5, size: "text-lg" },
  { emoji: "💎", delay: 0.6, x: "56%", y: "70%", duration: 4.5, size: "text-2xl" },
  { emoji: "🌟", delay: 0.9, x: "94%", y: "65%", duration: 3.5, size: "text-xl" },
  { emoji: "🔥", delay: 1.5, x: "85%", y: "35%", duration: 5.5, size: "text-xl" },
  { emoji: "🚀", delay: 1.8, x: "60%", y: "45%", duration: 4.2, size: "text-lg" },
];
      ...
      <div className="relative h-full flex flex-col">
        ...
        >
          ...
          {floatingParticles.map((particle, index) => (
            <motion.div
              key={index}
              className={`absolute pointer-events-none z-20 ${(particle as any).size || 'text-sm'}`}
          ...
          <div className="md:hidden relative z-10 my-4 px-3">
            <div 
              className="h-1 rounded-full"
              style={{
                background: `linear-gradient(90deg, 
