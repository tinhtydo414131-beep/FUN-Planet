...
export const AdminRealtimeBell = forwardRef<HTMLDivElement, AdminRealtimeBellProps>(
  ({ onNavigateToTab, onRefreshStats }, ref) => {
...
AdminRealtimeBell.displayName = "AdminRealtimeBell";
